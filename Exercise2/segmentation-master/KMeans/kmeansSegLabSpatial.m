function [I,meanImage] = kmeansSegLabSpatial(imrgb, k, weight)
...
error(nargchk(2, 3, nargin));       % Allow 2 inputs or 3
...
vecsab = cat( 2, vecsab, xvec, yvec );

% Run kmeans against the ab vecs
[idx, c] = kmeans_d(vecsab, k );
